		...
		<div class="container">
			...
			<div class="cards">
				...
				<div class="card-body">
					...
					<a href="https://youtu.be/gV0xrnhseYQ" class="btn btn-primary">Ver</a>
				</div>
			</div>
			<div class="cards">
				<img class="card-img-top" src="img/autos_chocadores.jpg" alt="100px">
				<div class="card-body">
					<h4 class="card-title">Autos Chocadores</h4>
					<p class="card-text">Altura mínima requerida 1,25 M</p>
					<a href="https://youtu.be/Sth9Jyf2ZKA" class="btn btn-primary">Ver</a>
				</div>
			</div>
			<div class="cards">
				<img class="card-img-top" src="img/musical_peliculas.jpg"
					alt="100px">
				<div class="card-body">
					...
					<p class="card-text">Un musical espectacular donde podrás
						...
						13hs y 17.30hs</p>
					<a href="https://youtu.be/dKdVDqYfDzc" class="btn btn-primary">Ver</a>
				</div>
			</div>
			<div class="cards">
				...
				<div class="card-body">
					...
					<p class="card-text">Altura mínima requerida para subir solo
						...
						directo</p>
					<a href="https://youtu.be/GGUo1h_3UKw" class="btn btn-primary">Ver</a>
				</div>
			</div>
